...
And every serious project needed the same setup again: project rules, coding conventions, review prompts, testing expectations, security guardrails, bugfix workflows, spec templates, and instructions for how the assistant should behave when it is unsure. I could copy those files by hand, but I work in more than one project and in a lot of different languages and stacks.

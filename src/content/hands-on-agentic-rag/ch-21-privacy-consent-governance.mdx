...
```mermaid
flowchart TD
    Q[Query for a pet] --> F[Filter by pet in retrieval]
...
- Retrieval is filtered by pet, in code, before ranking; role-based filtering is the production extension from Chapter 18.
- The model never decides access.
